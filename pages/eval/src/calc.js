...
function t(a) {
  ...
  for (var i = 0; i < a.length; i++) {
    if (a[i].type == "Literal") {
      ...
      case "+":
        {
          x[x.length - 2] = arb(x[x.length - 2]).add(x[x.length - 1]).value;
          x.pop();
          break;
        }
      case "-":
        {
          x[x.length - 2] = arb(x[x.length - 2]).sub(x[x.length - 1]).value;
          x.pop();
          break;
        }
      case "*":
        {
          x[x.length - 2] = arb(x[x.length - 2]).mul(x[x.length - 1]).value;
          x.pop();
          break;
        }
      case "/":
        {
          x[x.length - 2] = arb(x[x.length - 2]).div(x[x.length - 1]).value;
          x.pop();
          break;
        }
      case "^":
        {
          x[x.length - 2] = arb(x[x.length - 2]).pow(x[x.length - 1]).value;
          x.pop();
          break;
        }
      }
